...
class MeetingRecap(Base):
    ...
    # project_id is optional to support "pick project later" flow from dashboard
    project_id: Mapped[str | None] = mapped_column(CHAR(36), ForeignKey("projects.id", ondelete="CASCADE"), nullable=True)
