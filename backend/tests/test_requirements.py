...
class TestListRequirements:
    ...
    def test_list_requirements_by_section(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_list_requirements_404_project_not_found(self, auth_client: TestClient) -> None:
        ...
        response = auth_client.get(f"/api/projects/{fake_project_id}/requirements")

        assert response.status_code == 404
        assert response.json()["detail"] == "Project not found"

    def test_list_requirements_empty_project(self, auth_client: TestClient) -> None:
...
class TestCreateRequirement:
    ...
    def test_create_requirement_success(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_create_requirement_records_history(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_create_requirement_appends_to_section(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_create_requirement_different_section_starts_at_1(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_create_requirement_404_project_not_found(self, auth_client: TestClient) -> None:
    ...
    def test_create_requirement_invalid_section(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_create_requirement_missing_content(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_create_requirement_missing_section(self, auth_client: TestClient, test_db: Session) -> None:
...
class TestRequirementsStatusTransitions:
    ...
    def test_create_requirement_updates_status_to_has_items(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_delete_last_requirement_updates_status_to_empty(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_delete_does_not_change_status_if_items_remain(self, auth_client: TestClient, test_db: Session) -> None:
        ...
        auth_client.delete(f"/api/requirements/{req1_id}")

        # Status should remain has_items
        test_db.refresh(project)
        assert project.requirements_status == RequirementsStatus.has_items

    def test_create_does_not_downgrade_reviewed_status(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_delete_reviewed_with_remaining_items_keeps_reviewed(self, auth_client: TestClient, test_db: Session) -> None:
...
class TestUpdateRequirement:
    ...
    def test_update_requirement_increments_history_count(self, auth_client: TestClient, test_db: Session) -> None:
        ...
        # Second update
        response = auth_client.put(f"/api/requirements/{req_id}", json={"content": "v3"})

        data = response.json()
        assert data["history_count"] == 2

    def test_update_requirement_404_not_found(self, auth_client: TestClient) -> None:
...
class TestDeleteRequirement:
    ...
    def test_delete_requirement_404_not_found(self, auth_client: TestClient) -> None:
        ...
        response = auth_client.delete(f"/api/requirements/{fake_req_id}")
...
class TestReorderRequirements:
    ...
    def test_reorder_requirements_success(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_reorder_requirements_persists_in_list(self, auth_client: TestClient, test_db: Session) -> None:
...
class TestExportRequirements:
    ...
    def test_export_format_sources_table(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_export_content_type(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_export_content_disposition(self, auth_client: TestClient, test_db: Session) -> None:
    ...
    def test_export_404_project_not_found(self, auth_client: TestClient) -> None:
        """Test exporting requirements for non-existent project returns 404."""
        fake_project_id = "00000000-0000-0000-0000-000000000000"

        response = auth_client.get(f"/api/projects/{fake_project_id}/requirements/export")
...
class TestRequirementHistory:
    ...
    def test_get_history_ordered_desc(self, auth_client: TestClient, test_db: Session) -> None:
        ...
        auth_client.put(f"/api/requirements/{req_id}", json={"content": "v2"})
        auth_client.put(f"/api/requirements/{req_id}", json={"content": "v3"})
    ...
    def test_get_history_404_not_found(self, auth_client: TestClient) -> None:
        """Test getting history for non-existent requirement returns 404."""
        fake_req_id = "00000000-0000-0000-0000-000000000000"

        response = auth_client.get(f"/api/requirements/{fake_req_id}/history")
